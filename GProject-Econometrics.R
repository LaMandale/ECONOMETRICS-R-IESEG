...
RGDP <- Delt(rvdata3$GPD)

arima(RGDP, order = c(0,0,0))
arima(RGDP, order = c(0,0,1))
arima(RGDP, order = c(0,0,2))
arima(RGDP, order = c(0,0,3))
arima(RGDP, order = c(1,0,0))
arima(RGDP, order = c(1,0,1))
arima(RGDP, order = c(1,0,2))
arima(RGDP, order = c(1,0,3))
arima(RGDP, order = c(2,0,0))
arima(RGDP, order = c(2,0,1))
arima(RGDP, order = c(2,0,2))
arima(RGDP, order = c(2,0,3))
arima(RGDP, order = c(3,0,0))
arima(RGDP, order = c(3,0,1))
arima(RGDP, order = c(3,0,2))
arima(RGDP, order = c(3,0,3))
...
ARMARGDP1 <- arima(RGDP, order = c(1,0,0))
print(ARMARGDP1)
...
plot.ts(resid, main="Resid ARMA(1,0)")
...
plot.ts(gdpf, ylim = c(2400,3800), xlim = c(0,105))
